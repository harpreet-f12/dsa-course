...
public class Knapsack01 {
	...
	public int knapsackTab(int capacity, int[] wts, int[] vals) {
		...
		return knapsackTabImpl(capacity, wts.length, wts, vals);
	}
	
	private int knapsackTabImpl(int capacity, int itemCount, int[] wts, int[] vals) {	  
	...
	// DP using tabulation approach with space optimization
	public int knapsackTabOpt(int capacity, int[] wts, int[] vals) {
		...
		return knapsackTabOptImpl(capacity, wts.length, wts, vals);		
	}
	
	private int knapsackTabOptImpl(int capacity, int itemCount, int[] wts, int[] vals) {			
